...
<html>
  ...
  <body>
    	<table align="center" style="height: 358px; width: 1400px; margin-top: 200px;font-size: 20px;">
    		...
    		<tr>
    			<td colspan="6" align="center">
    				<a href="JianYiXServlet?currentPage=1"><input type="button" value="首页"/></a>
			    	<a href="JianYiXServlet?currentPage=${page.lastPage }"><input type="button" value="上一页"/></a>
			    	<c:forEach var="v" begin="1" end="${page.pageTotal}">
			    		<a href="JianYiXServlet?currentPage=${v }"><input type="button" value="${v }"/></a>
			    	</c:forEach>
			    	<a href="JianYiXServlet?currentPage=${page.nextPage }"><input type="button" value="下一页"/></a>
			    	<a href="JianYiXServlet?currentPage=${page.pageTotal}"><input type="button" value="尾页"/></a>
    			</td>
    		</tr>
    	</table>
